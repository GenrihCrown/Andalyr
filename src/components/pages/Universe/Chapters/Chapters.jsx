        ...
        return (
          <div className="item1">
            ...
            <p style={{ color: "#fff", padding: "5px", margin: "5px" }}>
              ...
              пространство света, не обремененное ни временем, ни расстоянием.
              двое одиноких путников вели неторопливую беседу. Любой, кто стал
              бы невольным их слушателем, сразу понял, что эти двое знакомы,
              вот уже очень и очень давно. Они оба скорее походили на двух
              братьев, что делились своими наблюдениями о мире, нежели на
              случайных знакомых.
            </p>
          </div>
        );
